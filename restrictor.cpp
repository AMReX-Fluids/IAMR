...
void 
cell_average_restrictor_class::fill(Fab& patch,
					 const Box& region,
					 Fab& fgr,
...
void 
injection_restrictor_class::fill(Fab& patch,
				      const Box& region,
				      Fab& fgr,
				      const IntVect& rat) const
{
...
void 
default_restrictor_class::fill(Fab& patch,
				    const Box& region,
				    Fab& fgr,
				    const IntVect& rat) const
{
...
void 
bilinear_restrictor_class::fill(Fab& patch,
				     const Box& region,
				     Fab& fgr,
				     const IntVect& rat) const
{
