...
//
// $Id: restrictor.cpp,v 1.11 1997-12-11 23:30:37 lijewski Exp $
//
...
Box 
cell_average_restrictor_class::box(const Box& fb, const IntVect& rat) const
{
  Box retbox(fb);
...
Box 
injection_restrictor_class::box(const Box& fb, const IntVect& rat) const
{
  Box retbox(fb);
  return retbox.coarsen(rat);
}
...
Box 
default_restrictor_class::box(const Box& fb, const IntVect& rat) const
{
  Box retbox(fb);
  return retbox.coarsen(rat);
}
...
void 
default_restrictor_class::fill(FArrayBox& patch,
                                    const Box& region,
                                    FArrayBox& fgr,
                                    const IntVect& rat) const
{
...
Box 
bilinear_restrictor_class::box(const Box& fb, const IntVect& rat) const
{
  Box retbox(fb);
...
void 
bilinear_restrictor_class::interface(FArrayBox& patch,
                                          const Box& region,
                                          MultiFab& fine,
#ifdef HG_USE_CACHE
...
void 
bilinear_restrictor_coarse_class::interface(FArrayBox& patch,
                                            const Box& region,
                                            MultiFab& fine,
#ifdef HG_USE_CACHE
                                            const copy_cache* border_cache,
