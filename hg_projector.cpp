//
// $Id: hg_projector.cpp,v 1.13 1997-11-18 18:31:34 car Exp $
//
...
void 
holy_grail_amr_projector::sparse_node_source_adjustment(PArray<MultiFab>&
							     sparse_source)
{
...
{ 
  ...
  if (singular) 
  {
    ...
    restrict_level(source[lev_min], false, source[lev_min+1],
		   gen_ratio[lev_min],
#ifdef HG_USE_CACHE
		   0,
#endif
