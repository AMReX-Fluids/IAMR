...
geometry.prob_lo     =  -1. 0. 0. # physical dimensions of the low end of the domain
geometry.prob_hi     =  1. 1. 1. # physical dimensions of the high end of the domain
...
ns.lo_bc             = 0 5 5 # boundary conditions on the low end of the domain
ns.hi_bc             = 0 5 5 # boundary conditions on the high end of the domain
...
RunStats.statvar = vel_predict vel_advect scal_advect vel_update scal_update
                   ...
                   collect_data mpi_waitall mpi_barrier mpi_reduce 
                   mpi_broadcast mpi_gather mpi_recv mpi_send
