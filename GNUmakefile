#
# $Id: GNUmakefile,v 1.61 1998-11-20 21:21:08 lijewski Exp $
#
PBOXLIB_HOME = ..
...
ifeq ($(USE_HGPROJ_SERIAL),FALSE)
	cd $(TOP)/hgproj;    $(MAKE) PRECISION=$(PRECISION) PROFILE=$(PROFILE) COMP=$(COMP) DEBUG=$(DEBUG) DIM=$(DIM) USE_MPI=$(USE_MPI) LBASE=proj EBASE=
else
