...
!      integer(c_int),  intent(in   ) :: ng
      ...
      ! BC types
      integer(c_int), intent(in   ) ::  wbc(SDIM,2) 
      !integer(c_int), intent(in   ) ::  &
   ...
   ! $************************************************
   ! $
   ! $ compute convective term is  div(u_mac c)
   ! $
   ! $************************************************
   subroutine compute_divuc_eb ( lo, hi, &
                                 divuc, glo, ghi, &
                                 vel, vello, velhi, &
                                 u, ulo, uhi, &
                                 v, vlo, vhi, &
      ...
      integer(c_int),  intent(in   ) :: vflo(3), vfhi(3)
      integer(c_int),  intent(in   ) ::  blo(3),  bhi(3)
      integer(c_int),  intent(in   ) :: domlo(3), domhi(3), ng ! ,ncomp
