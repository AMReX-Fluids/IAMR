...
\graphicspath{{Parallel/}{Visualization/}}
%\graphicspath{{PeleLMVerification/}{ConvertCheckpoint/}{Parallel/}{Scaling/}{Visualization/}}
...
\newcommand{\combustion}{{\sf Combustion}}
\newcommand{\yt}{{\sf yt}}
...
\HRule\\[2mm]
\centering
{\Large \em An adaptive, parallel, hydrodynamics code for\\
...
%-----------------------------------------------------------------------------
\part{Overview of the \iamr\ Algorithm}

\chapter{Introduction}
\input Introduction/Introduction

\chapter{Equation Set}
...
\input UnitsAndConstants/Units.tex

\chapter{Software Framework}
\input Software/Software.tex
\input Parallel/Parallel.tex

\chapter{AMR}
\input AMR/AMR.tex

\chapter{Visualization}
\input Visualization/Visualization.tex
